...
class _$SettingStateImpl implements _SettingState {
  const _$SettingStateImpl({this.isLoading = false, this.user});
  ...
  @override
  String toString() {
    return 'SettingState(isLoading: $isLoading, user: $user)';
  }
...
abstract class _SettingState implements SettingState {
  const factory _SettingState({final bool isLoading, final MUser? user}) =
      _$SettingStateImpl;
